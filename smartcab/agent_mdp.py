...
from visuals import get_reliability
...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        if not (0 < epsilon < 1):
            raise ValueError("Policy must have 0 < epsilon < 1")
        self.epsilon = epsilon   # Exploration rate

        if not (0 < alpha < 1):
            raise ValueError("Policy must have 0 < alpha < 1")
        ...
        #
        self.num_success_over_trials = 0
        self.num_success_over_training = 0
        self.num_trials = 0
        self.num_steps = 0
    ...
    def reset(self, destination=None, testing=False):
        ...
        self.num_trials += 1 # Mark initiation of new trial
        if self.env.isSuccess():
            self.num_success_over_trials += 1
    ...
    def build_state(self):
        ...
        self.num_steps += 1 # Mark new step
...
if __name__ == '__main__':
    ...
    log_filename_parameter_eval = os.path.join("logs", "param_eval.csv")
    out = open(log_filename_parameter_eval,'w')
    ...
    for i in list_alpha:
        for k in list_epsilon:
            LearningAgent.setAlpha(i)
            LearningAgent.setEpsilon(k)
            success_list, optimal_path_found_list = run()                              # run(arg1, arg2)
            success_ratio = LearningAgent.num_success_over_trials / (1.0 * LearningAgent.num_trials)
            reliability = get_realiability("sim_improved-learning.csv")
